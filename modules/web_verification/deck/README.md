...
- Extensión: `.deck.json`.
- Ubicación sugerida: `modules/web_verification/deck/examples/<project_slug>.deck.json` para proyectos incluidos en el repo. En producción se puede apuntar a otra ruta con `--deck`.
