#!/usr/bin/env python3
"""
Test runner for task generation tests.

This script runs all task generation tests and provides detailed output.
"""
...
from test_prompts_and_config import TestBrowserSpecification, TestPromptTemplates, TestTaskGenerationConfig, TestTaskModelValidation, TestUseCaseIntegration, TestWebProjectIntegration
from test_task_generation_pipeline import TestGlobalTaskGenerationPipeline, TestTaskCaching, TestTaskGenerationIntegration, TestTaskGenerationPipeline, TestTaskValidation
from test_test_generation import TestGlobalTestGenerationPipeline, TestTestClasses, TestTestGenerationIntegration
