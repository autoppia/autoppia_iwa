...
PROJECT_ID = "p15_autostats"
PROJECT_NAME_LEGACY = "autostats"
FIXTURE = load_project_fixture(PROJECT_ID)


def test_trajectories_p15_fixture_contains_only_autostats():
...
async def test_trajectories_p15(index: int, trajectory: dict):
