...
PROJECT_ID = "p14_autohealth"
PROJECT_NAME_LEGACY = "autohealth"
FIXTURE = load_project_fixture(PROJECT_ID)


def test_trajectories_p14_fixture_contains_only_autohealth():
...
async def test_trajectories_p14(index: int, trajectory: dict):
