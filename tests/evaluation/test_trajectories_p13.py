...
PROJECT_ID = "p13_autodrive"
PROJECT_NAME_LEGACY = "autodrive"
FIXTURE = load_project_fixture(PROJECT_ID)


def test_trajectories_p13_fixture_contains_only_autodrive():
...
async def test_trajectories_p13(index: int, trajectory: dict):
