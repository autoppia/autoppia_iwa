...
PROJECT_ID = "p11_autocalendar"
PROJECT_NAME_LEGACY = "autocalendar"
FIXTURE = load_project_fixture(PROJECT_ID)


def test_trajectories_p11_fixture_contains_only_autocalendar():
...
async def test_trajectories_p11(index: int, trajectory: dict):
