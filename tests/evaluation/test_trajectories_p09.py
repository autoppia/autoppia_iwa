...
PROJECT_ID = "p09_autoconnect"
PROJECT_NAME_LEGACY = "autoconnect"
FIXTURE = load_project_fixture(PROJECT_ID)


def test_trajectories_p09_fixture_contains_only_autoconnect():
...
async def test_trajectories_p09(index: int, trajectory: dict):
