...
class TaskGenerationByEasyDifficultyTest(unittest.TestCase):
    ...
    # Easy Level Tests
    def test_easy_tasks_generation_only(self):
        self._test_task_generation(include_actions=False, include_evaluation=False)

    def test_easy_tasks_generation_with_actions(self):
        self._test_task_generation(include_actions=True, include_evaluation=False)

    def test_easy_tasks_generation_with_actions_and_evaluation(self):
