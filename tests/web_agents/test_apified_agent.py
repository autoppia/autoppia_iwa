...
def test_apified_web_agent_uses_stub_endpoint(stub_agent):
    ...
    agent = ApifiedWebAgent(base_url=stub_agent.base_url, id="agent-1", name="StubAgent")
...
def test_apified_agent_raises_when_endpoint_unavailable():
    agent = ApifiedWebAgent(base_url="http://127.0.0.1:65500", id="agent-err", name="ErrAgent", timeout=1)
    task = Task(url="https://example.com", prompt="Click CTA", web_project_id="dummy")
