...
from autoppia_iwa.src.data_generation.tests.classes import JudgeBaseOnHTML, JudgeBaseOnScreenshot
...
class WebVoyagerConfig:
    ...
    tasks_cache_dir: Path = cache_dir / "tasks"
    solutions_cache_dir: Path = cache_dir / "solutions"
    output_dir: Path = benchmark_dir / "results"

    def __post_init__(self):
        for directory in (self.benchmark_dir, self.cache_dir, self.tasks_cache_dir, self.solutions_cache_dir, self.output_dir):
