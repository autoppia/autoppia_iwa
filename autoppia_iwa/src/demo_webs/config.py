...
async def initialize_test_demo_web_projects():
    test_demo_web_projects = [WebProject(name="Autoppia", backend_url="", frontend_url="https://www.autoppia.com", is_web_real=True, events=[], relevant_data=relevant_data_web_1)]
