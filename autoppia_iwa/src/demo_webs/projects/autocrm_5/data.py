...
FIELD_OPERATORS_MAP_CLIENT_VIEW_MATTER = {
    ...
    "status": [EQUALS, NOT_EQUALS, IN_LIST, NOT_IN_LIST],
    "matters": [EQUALS, NOT_EQUALS, GREATER_THAN, LESS_THAN, GREATER_EQUAL, LESS_EQUAL],
}
...
FIELD_OPERATORS_MAP_CALENDAR = {
    ...
    "time": [EQUALS, NOT_EQUALS, GREATER_THAN, LESS_THAN, GREATER_EQUAL, LESS_EQUAL],
...
FIELD_OPERATORS_MAP_LOG = {
    ...
    "client": [EQUALS, NOT_EQUALS, CONTAINS, NOT_CONTAINS],
    "hours": [EQUALS, NOT_EQUALS, GREATER_THAN, LESS_THAN, GREATER_EQUAL, LESS_EQUAL],
    "status": [EQUALS, NOT_EQUALS, IN_LIST, NOT_IN_LIST],
}
