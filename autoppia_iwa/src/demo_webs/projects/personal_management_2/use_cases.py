...
from .replace_function import user_redirect_replace_func, user_view_replace_func
...
USER_VIEW_USE_CASE = UseCase(
    ...
    replace_func=user_view_replace_func,
    examples=[
        {
...
USER_REDIRECT_USE_CASE = UseCase(
    ...
    replace_func=user_redirect_replace_func,
    examples=[
        {
