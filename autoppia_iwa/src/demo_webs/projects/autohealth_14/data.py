...
FIELD_OPERATORS_MAP_UPLOAD_HEALTH_DATA = {
    "file_count": EQUALITY_OPERATORS,
    "file_names": STRING_OPERATORS,
    "upload_timestamp": EQUALITY_OPERATORS,
}
...
FIELD_OPERATORS_MAP_CANCEL_VIEW_REVIEWS = {**FIELD_OPERATORS_MAP_CANCEL_CONTACT_DOCTOR}
