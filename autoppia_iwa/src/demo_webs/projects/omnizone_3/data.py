PRODUCTS_DATA = [
    {
        ...
        "price": "$160.00",
        "description": "High-quality espresso machine for your home barista needs. Features programmable brewing options and a built-in milk frother.",
        "category": "Kitchen",
        "rating": 4.5,
        "brand": "SumKea",
        "inStock": True,
    },
    {
        ...
        "price": "$90.00",
        "description": "Multi-functional pressure cooker with 10 preset cooking modes. Makes meal preparation quick and easy.",
        "category": "Kitchen",
        "rating": 4.7,
        "brand": "SumKea",
        "inStock": True,
    ...
    {
        "id": "kitchen-3",
        "title": "Steel Pots Set",
        "price": "$39.99",
        "description": "Set of 3 stainless steel pots with lids. Dishwasher safe and suitable for all cooking surfaces including induction.",
        "category": "Kitchen",
        "rating": 4.2,
        "brand": "SumKea",
        "inStock": True,
    },
    {
        ...
        "price": "$32.50",
        "description": "Fast-boiling electric kettle with automatic shut-off and boil-dry protection. 1.7L capacity.",
        "category": "Kitchen",
        "rating": 4.4,
        "brand": "SumKea",
        "inStock": True,
    },
    {
        ...
        "description": "Premium nonstick frying pan with ergonomic handle. PFOA-free coating and induction compatible.",
        "category": "Kitchen",
        "rating": 4.3,
        "brand": "SumKea",
        "inStock": True,
    ...
    },
    {
        ...
        "title": "Gaming PC",
        "price": "$985.00",
        "description": "High-performance gaming PC with RGB lighting. Features the latest processor and graphics card for smooth gameplay.",
        "category": "Technology",
        "rating": 4.8,
        "brand": "TechPro",
        "inStock": True,
    },
    {
        ...
        "price": "$400.23",
        "description": "34-inch curved gaming monitor with high refresh rate and adaptive sync technology for immersive gaming experience.",
        "category": "Technology",
        "rating": 4.6,
        "brand": "TechPro",
        "inStock": True,
    },
    {
        ...
        "title": "Graphics Card",
        "price": "$210.75",
        "description": "Latest generation graphics card with ray tracing capability. Perfect for gaming and content creation.",
        "category": "Technology",
        "rating": 4.9,
        "brand": "TechPro",
        "inStock": True,
    ...
    },
    {
        ...
        "title": "Bedding Set",
        "price": "$89.50",
        "description": "Premium microfiber bedding set including duvet cover, fitted sheet, and pillowcases. Soft, durable, and easy to care for.",
        "category": "Home",
        "rating": 4.5,
        "brand": "SumKea",
        "inStock": True,
