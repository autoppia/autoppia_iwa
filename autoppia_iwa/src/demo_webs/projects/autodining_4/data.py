...
OPERATORS_ALLOWED_COUNTRY_SELECTED = {
    **OPERATORS_ALLOWED_BOOK_RESTAURANT,
    ...
    "code": [EQUALS, NOT_EQUALS],
}

OPERATORS_ALLOWED_OCCASION_SELECTED = {
    **OPERATORS_ALLOWED_BOOK_RESTAURANT,
    "occasion": [EQUALS, NOT_EQUALS],
}
...
# Visible fields for data-extraction use cases
VISIBLE_FIELDS_RESTAURANT_DETAIL = ["name", "rating", "reviews", "cuisine", "area"]
VISIBLE_FIELDS_SEARCH_RESTAURANT = ["name", "rating", "cuisine", "area", "reviews"]
