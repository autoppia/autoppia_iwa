from autoppia_iwa.src.demo_webs.operators import CONTAINS, EQUALS, GREATER_EQUAL, GREATER_THAN, LESS_EQUAL, LESS_THAN, NOT_CONTAINS, NOT_EQUALS
...
FIELD_OPERATORS_VIEW_ALL_RECOMMENDATIONS_MAP = {"source": STRING_OPERATORS}

FIELD_OPERATORS_VIEW_NOTIFICATIONS_MAP = {
    "total_count": LOGICAL_OPERATORS,
    "unread_count": LOGICAL_OPERATORS,
    "source": STRING_OPERATORS,
}

FIELD_OPERATORS_FILTER_NOTIFICATIONS_MAP = {
    "filter_key": STRING_OPERATORS,
}

FIELD_OPERATORS_MARK_NOTIFICATION_READ_MAP = {
    "notification_id": STRING_OPERATORS,
    "notification_type": STRING_OPERATORS,
