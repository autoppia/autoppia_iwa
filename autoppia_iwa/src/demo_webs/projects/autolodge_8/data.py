...
REGION_HOTELS = [
    {
        ...
        "amenities": [
            ...
            {"icon": "📍", "title": "Great location", "desc": "100% of recent guests gave the location a 5-star rating."},
            {"icon": "🔍", "title": "Great check-in experience", "desc": "100% of recent guests gave the check-in process a 5-star rating."},
        ],
    },
    {
        ...
        "amenities": [
            {"icon": "🏝", "title": "Lake view", "desc": "Enjoy beautiful sunrises on the water."},
            {"icon": "🌬", "title": "Mountain views", "desc": "Views of the Rockies from the balcony."},
            {"icon": "🛌", "title": "Family friendly", "desc": "Cribs, highchair, and backyard play area."},
        ],
    },
    {
        ...
        "amenities": [
            {"icon": "🥳", "title": "Hot tub", "desc": "Relax after your alpine adventure."},
            {"icon": "🍽", "title": "Gourmet kitchen", "desc": "Fully equipped for family meals."},
            {"icon": "🏖", "title": "Resort access", "desc": "Free shuttle to ski slopes."},
        ],
    },
    {
        ...
        "amenities": [{"icon": "📚", "title": "Library", "desc": "Curated collection of Parisian literature."}, {"icon": "🎠", "title": "Central location", "desc": "Steps from the Metro."}],
    },
    {
        ...
        "amenities": [
            {"icon": "🏖", "title": "Beach access", "desc": "Walk to sand in 3 minutes."},
            {"icon": "🌊", "title": "Private pool", "desc": "Heated and fenced."},
            {"icon": "🛸", "title": "Bikes included", "desc": "Surf the coast!"},
        ],
    },
    {
        ...
        "amenities": [{"icon": "🍃", "title": "Garden", "desc": "Outdoor seating and flower beds."}, {"icon": "⛰", "title": "Country views", "desc": "See sheep and rolling hills."}],
    },
    {
        ...
        "amenities": [{"icon": "🌿", "title": "Private garden", "desc": "Secluded space for relaxation."}, {"icon": "🏰", "title": "Historic building", "desc": "18th-century canal house."}],
    },
    {
        ...
        "amenities": [{"image": "💻", "title": "Fast Wi-Fi", "desc": "1Gbps optic fiber."}, {"icon": "🧰", "title": "Washer/dryer", "desc": "Laundry in unit."}],
    },
    {
        ...
        "amenities": [
            {"icon": "🏖", "title": "Beachfront", "desc": "Step outside to the Aegean Sea."},
            {"icon": "🛋", "title": "Infinity pool", "desc": "Swim with an endless horizon."},
            {"icon": "🎡", "title": "Nightlife nearby", "desc": "Close to beach bars and clubs."},
        ],
    },
    {
        ...
        "amenities": [
            {"icon": "📱", "title": "High-speed Wi-Fi", "desc": "1Gbps fiber for work or play."},
            {"icon": "📺", "title": "Smart TV", "desc": "Includes Netflix & Prime."},
            {"icon": "🖥", "title": "City view", "desc": "Panoramic skyline at night."},
        ],
    },
    {
        ...
        "amenities": [
            {"icon": "🌿", "title": "Private courtyard", "desc": "Relax in traditional decor."},
            {"icon": "🍯", "title": "Mint tea service", "desc": "Daily Moroccan mint tea."},
            {"icon": "🏨", "title": "Local art", "desc": "Handcrafted tile and textiles."},
        ],
    },
    {
        ...
        "amenities": [
            {"icon": "❄", "title": "Aurora views", "desc": "Glass roof for watching the Northern Lights."},
            {"icon": "🧴", "title": "Sauna included", "desc": "Private Finnish sauna with wood stove."},
            {"icon": "🌿", "title": "Eco-heated", "desc": "Geothermal underfloor heating system."},
        ],
    },
]
