...
class SelectTodayEvent(SelectViewEvent):
    ...
    def _validate_criteria(self, criteria: ValidationCriteria | None = None) -> bool:
        ...
        return all(
            [
                ...
                any(self._validate_field(at, criteria.attendees) for at in self.attendees) if criteria.attendees else True,
                any(self._validate_field(rem, criteria.reminders) for rem in self.reminders) if criteria.reminders else True,
