...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--steps-file", type=Path, default=Path("data/inputs/reward_model/features/dom_event_steps.jsonl"))
    parser.add_argument("--output", type=Path, default=Path("data/inputs/reward_model/ckpts/dom_event_baseline.pkl"))
