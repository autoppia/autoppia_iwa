...
class LLMReviewer:
    ...
    async def review_task_and_constraints(self, task: Task) -> dict[str, Any]:
        ...
        system_prompt = (
            ...
            "   Valid prompt variations: 'NOT', 'not equals', 'not equal to', 'is not', 'is NOT', '!=' (symbol), 'different from', 'excluding', 'other than', 'anything but', 'not being'\n"
            "   CRITICAL: 'is NOT' or 'is not' is a CORRECT representation of 'not_equals'.\n"
            ...
            "   Valid prompt variations: 'NOT contains', 'not contains', 'does not contain', 'excluding', 'without', 'not including', 'that does not contain', 'not having'\n"
