...
class LLMReviewer:
    ...
    async def review_task_and_constraints(self, task: Task) -> dict[str, Any]:
        ...
        system_prompt = (
            ...
            '   - For the "equals" operator, the word "equals" may appear or may be implicit.\n'
            ...
            "1. For each constraint, check the FIELD is explicitly mentioned in the prompt.\n"
            "2. Verify the OPERATOR is semantically represented (natural language variations are allowed for all OPERATORS).\n"
