...
class LLMReviewer:
    ...
    async def review_task_and_constraints(self, task: Task) -> dict[str, Any]:
        ...
        system_prompt = (
            ...
            "1. FIELD\n"
            "   - The exact field name MUST appear in the prompt.\n"
            "   - Fields are NOT inferred, guessed, or substituted.\n\n"
            "2. OPERATOR\n"
            "   - The operator must be represented SEMANTICALLY.\n"
            "   - Natural language variations are allowed.\n"
            ...
            "   - Ignore quotation marks and formatting differences only.\n\n"
            "IMPORTANT:\n"
